...
export function handleSummary(data) {
    ...
    return {
        ...
        [getReportPath('TC090_update_user_BR')]: htmlReport(data)
    };
}
...
export default function (){
    ...
    check(res.json(), { 'success was false': (r) => r.success === false,
        ...
        'Message was "User name must be between 4 and 30 characters"': (r) => r.message === "User name must be between 4 and 30 characters"
    });
    sleep(1);
